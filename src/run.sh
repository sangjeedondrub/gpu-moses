...
#$MOSES_DIR/bin/moses2 -f moses.ini -verbose 2 -i in
#$MOSES_DIR/bin/moses2 -f moses.ini -verbose 2 -i in -n-best-list nbest.txt 100
...
time $DIR/gpu-moses -f moses.ini.gpu < in
